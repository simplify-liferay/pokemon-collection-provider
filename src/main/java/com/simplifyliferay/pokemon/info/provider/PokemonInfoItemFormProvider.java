...
public class PokemonInfoItemFormProvider implements InfoItemFormProvider<Pokemon> {
    ...
    public InfoForm getInfoForm() {
        ...
        return InfoForm.builder(
                ...
                _templateInfoItemFieldSetProvider.getInfoFieldSet(Pokemon.class.getName())
        ).infoFieldSetEntry(
            _pokemonInfoItemFieldSetProvider.getInfoFieldSet()).labelInfoLocalizedValue(infoLocalizedValueBuilder.build()
        ).name(
